    ...
    <div className="p-4 lg:p-8 max-w-5xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm">
            Track inventory and get reorder alerts
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        {[
          ...
          <div key={stat.label} className="bg-white rounded-xl border border-gray-200 p-3 lg:p-4">
            <p className="text-xs text-gray-500 font-medium uppercase tracking-wide leading-tight">
              {stat.label}
            </p>
            <p className={`text-2xl lg:text-3xl font-bold mt-1 ${stat.color}`}>
              {stat.value}
            </p>
          </div>
        ))}
      ...
      {supplies && supplies.length > 0 ? (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="text-xs text-gray-500">
                      Min: {supply.min_stock} {supply.unit}
                    </span>
                  </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-400 text-sm mt-1">
            Click "Add Supply" above to get started
          </p>
        </div>
      )}
    </div>
